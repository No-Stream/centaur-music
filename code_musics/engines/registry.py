...
_PRESETS: dict[str, dict[str, dict[str, Any]]] = {
    ...
    "synth_voice": {
        ...
        "drawbar_diode_acid": {
            ...
            # envelope, ``dirt=0.5`` auto-wires preamp saturation.
        ...
        "flow_exciter_pad": {
            # Breath-like flow exciter over an additive pad.  SVF notch morph
            # animates the upper partials; long ``movement`` macro.
            "partials_type": "additive",
            "partials_n_harmonics": 14,
        ...
        "tonewheel_drive": {
            ...
            # Korg MS-20 K35 filter with some edge.
            "partials_type": "drawbars",
            "noise_type": "pink",
            "noise_level": 0.08,
            "filter_mode": "lowpass",
