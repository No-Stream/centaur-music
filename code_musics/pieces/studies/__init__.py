...
from code_musics.pieces.studies.study_aksak import PIECES as _AKSAK_PIECES
...
from code_musics.pieces.studies.study_rhythm_transforms import (
    PIECES as _RHYTHM_TRANSFORMS_PIECES,
)
