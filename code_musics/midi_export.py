...
from code_musics.midi_export_tuning import analyze_tuning, write_tuning_files
...
def export_midi_bundle(
    ...
    *,
    ...
    manifest = MidiBundleManifest(
        ...
        warnings=(
            ["Shared tuning files are approximate convenience exports."]
    ...
    readme_path.write_text(_build_bundle_readme(tuning_analysis), encoding="utf-8")
...
def _build_bundle_readme(tuning_analysis: TuningAnalysisResult) -> str:
    warning_line = ""
    if tuning_analysis.is_approximate:
        warning_line = (
